<template>
  <div class="activities-accordion">
    ...
    <div class="accordion">
      <div v-for="(activity, index) in activities" :key="index" class="accordion-item">
        <!-- Accordion Header -->
...
// Reactive state for the currently expanded accordion item
const expandedIndex = ref<null | number>(0)
